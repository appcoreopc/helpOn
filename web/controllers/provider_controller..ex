defmodule HelpOn.ProviderController do
  ...
  def handleRequest(conn, %{"id" => id }) do 
    ...
    dataRecord = ProviderService.getService(elem(element, 0))
  ...
  def createRequest(conn, params) do 
    case ProviderService.createRequest(conn, params) do 
  ...
  def cancelRequest(conn, %{"id" => id}) do
    element = Integer.parse(id)    
    try do 
      case ProviderService.deleteRequest(elem(element, 0)) do
  ...
  def updateRequest(conn, params) do 
    try do 
      ...
      case ProviderService.updateRequest(elem(element, 0), params) do 
